...
BLE (Bluetooth Low Energy) BLE logic:
...
* BLE works using 'services, which are a kind of data packages. Central devices
can 'subscribe' on such services
...
BLEFloatCharacteristic punch(
    "95ff7bf8-aa6f-4671-82d9-22a8931c5388",  // must differ from service UUID
    BLERead | BLENotify);
